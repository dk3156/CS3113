...
enum AIType     { WALKER, GUARD, ATTACKER, WEAPON};
...
public:
    ...
    //when colliding with an enemy through y and x at the same time, we need only y to be checked
    ...
    void activate_ai(Entity *player, Entity* weapon);
    void ai_walker();
    void ai_guard(Entity *player);
    void ai_attacker(Entity *player, Entity *weapon);
    void use_weapon(Entity *weapon);
